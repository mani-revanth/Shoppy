...
export default function BasicDemo() {
    ...
    useEffect(()=>{
        axios.post("http://localhost:5000/get_men_cards",{}).then((res)=>{
            setProducts(res.data[0].products_array);
        });
    },[]);
                ...
                <div className="flex flex-column xl:flex-row xl:align-items-start p-4 gap-4">
                    ...
                    <div className="flex flex-column sm:flex-row justify-content-between align-items-center xl:align-items-start flex-1 gap-4">
                        ...
                        <div className="flex sm:flex-column align-items-center sm:align-items-end gap-3 sm:gap-2">
                            ...
                            <Button1 icon="pi pi-shopping-cart" className="p-button-rounded" disabled={product.inventoryStatus === 'OUTOFSTOCK'}></Button1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="col-12 sm:col-6 lg:col-12 xl:col-4 p-2">
                <div className="p-4 border-1 surface-border surface-card border-round" style={{width:'100%',height:'100%'}}>
                    ...
                    <div className="flex flex-column align-items-center gap-3 py-5">
                        ...
                        <div className="text-2xl font-bold">{`${product.card_title}`}</div>
    ...
    return (
        <div style={{overflowY:'scroll',width:'100hw',height:'100vh'}}>
        <div className="card">
